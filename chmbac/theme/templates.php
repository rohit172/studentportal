...
<title><?php echo $title; ?> | ROHIT DADWAL'S Student Management System.</title>
...
<div class="navbar-fixed-top navbar-TOPsm container "    role="navigation">
  <div class="container">
    <div class="navbar-header">
          <h5 class="navbar-menu p" >ROHIT DADWAL'S Student Management System.</h5>
  ...
  <div class=" container stretch " style="margin-top:-30px;"> 
    <div class="row">
        <img  src="<?php echo web_root; ?>image/head2.png"   >  
    </div>
  </div> 
 <div class="navbar   navbar-magbanua  container"    role="navigation">
      ...
      <div class="container ">
       ...
       <!--  <a class="navbar-brand"  href="<?php echo web_root; ?>index.php" title="View Sites">ROHIT DADWAL'S Student Management System.</a> -->
        </div>
...
?>
            ...
            <footer class="panel-footer" style="background-color:#025eb1;color:#fff;" >
              <p align="center" >&copy; ROHIT DADWAL'S Student Management System.</p>
           </footer>
      </div>
